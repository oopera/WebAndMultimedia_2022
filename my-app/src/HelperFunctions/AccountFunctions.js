...
export async function updateUser(props){
    ...
    const response = await fetch(`https://webundmultimedia2022.herokuapp.com/updateUser/${props.isLoggedIn._id.toString()}`, {
        method: "post",
        headers: {
...
export async function login(props){
    ...
    const res = await fetch("https://webundmultimedia2022.herokuapp.com/users/login", {
        method: "post",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function register(props){
    ...
    const response = await fetch("https://webundmultimedia2022.herokuapp.com/users/add", {
        method: "post",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function deleteUser(id, users, setUsers, setComments) {
    ...
    await fetch(`https://webundmultimedia2022.herokuapp.com/delUser/${id}`, {
        method: "DELETE"
    });
...
export async function deleteOwnAccount(isLoggedIn, setLoggedIn, setComments, setOpenedItem) {
    ...
    await fetch(`https://webundmultimedia2022.herokuapp.com/delUser/${isLoggedIn._id}`, {
        method: "DELETE"
    });
...
export async function deleteComment(comment) {
    ...
    if(comment.id === undefined){
        await fetch(`https://webundmultimedia2022.herokuapp.com/delComment/${comment._id}`, {
            method: "DELETE"
        });

    } else {
        await fetch(`https://webundmultimedia2022.herokuapp.com/delComment/${comment.id}`, {
            method: "DELETE"
        });
    }
}
